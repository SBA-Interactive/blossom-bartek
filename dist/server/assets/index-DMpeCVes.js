...
import { y as cn, h as BlurFade, J as AnimatedGradientText, f as Button, l as Separator, C as Card, m as CardHeader, n as CardTitle, o as CardContent, p as CardDescription, u as useWishlistStore, D as useCompareStore, B as Badge, j as TooltipContent, T as TooltipTrigger, k as Tooltip, K as CardAction, G as CardFooter, z as products$1 } from "./router-DBR8M-aC.js";
import { useRef, useEffect } from "react";
import { N as NumberTicker, A as AboutPage } from "./About-DHaLYAkX.js";
import { Link, useNavigate } from "@tanstack/react-router";
import { ArrowRight, Leaf, Recycle, Sparkles, Heart, Scale, ShoppingBag, Flower2 } from "lucide-react";
import { B as BLUR_FADE_DELAY_MEDIUM, b as BLUR_FADE_DELAY_LONG, e as BLUR_FADE_DELAY_EXTRA_LONG, f as BLUR_FADE_DELAY_MAX, d as ANIMATED_LIST_STAGGER, a as BLUR_FADE_DELAY_SHORT, A as ANIMATED_LIST_DELAY, g as BLUR_FADE_DELAY_EXTRA_LONG_2 } from "./animation-DXk-6j-p.js";
import { A as AnimatedList } from "./animated-list-B7dWlxnH.js";
...
function Hero() {
  ...
  if ($[2] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t2 = /* @__PURE__ */ jsx(BlurFade, { delay: BLUR_FADE_DELAY_MEDIUM, children: /* @__PURE__ */ jsxs("h1", { className: "text-hero-text text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-heading font-bold leading-tight", children: [
  ...
  if ($[3] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t3 = /* @__PURE__ */ jsx(BlurFade, { delay: BLUR_FADE_DELAY_LONG, children: /* @__PURE__ */ jsx("p", { className: "text-hero-text/70 text-base sm:text-lg max-w-lg leading-relaxed", children: "Discover our collection of natural, eco-friendly perfumes crafted from upcycled fruit peels. Fresh, modern scents that are safe for everyday use." }) });
    $[3] = t3;
  } else {
    t3 = $[3];
  }
  let t4;
  if ($[4] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t4 = /* @__PURE__ */ jsx(Button, { size: "lg", className: "group bg-brand-rose text-white hover:bg-brand-rose/80 active:bg-brand-rose/70 text-base px-8 py-6 h-auto font-semibold transition-all duration-200", asChild: true, children: /* @__PURE__ */ jsxs(Link, { to: "/products", children: [
      "Shop Now",
  ...
  let t5;
  if ($[5] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t5 = /* @__PURE__ */ jsx(BlurFade, { delay: BLUR_FADE_DELAY_EXTRA_LONG, children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col sm:flex-row flex-wrap gap-4", children: [
      t4,
  ...
  if ($[6] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t6 = /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center sm:items-start text-center sm:text-left", children: [
  ...
  if ($[8] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t8 = /* @__PURE__ */ jsxs("dl", { className: "grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-8 w-full", children: [
      t6,
      t7,
    ...
    t9 = /* @__PURE__ */ jsx(Separator, { orientation: "horizontal", className: "mb-0 w-20 h-px bg-white/20" });
    $[8] = t8;
    $[9] = t9;
  } else {
    t8 = $[8];
  ...
  if ($[10] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t10 = /* @__PURE__ */ jsxs("div", { className: "space-y-8", children: [
      t2,
      t3,
      t5,
  ...
  if ($[11] === /* @__PURE__ */ Symbol.for("react.memo_cache_sentinel")) {
    t11 = /* @__PURE__ */ jsxs("section", { "aria-label": "Welcome to Blossom", className: "relative min-h-[90vh] flex items-center overflow-hidden bg-hero-bg text-hero-text pb-12", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-24", children: /* @__PURE__ */ jsxs("div", { className: "grid lg:grid-cols-2 gap-16 items-center", children: [
        t10,
        /* @__PURE__ */ jsx(BlurFade, { delay: BLUR_FADE_DELAY_LONG, children: /* @__PURE__ */ jsxs("figure", { className: "relative flex justify-center lg:justify-end", children: [
          /* @__PURE__ */ jsx("div", { className: "relative w-full max-w-md lg:max-w-lg aspect-[3/4]", children: /* @__PURE__ */ jsx("img", { src: "/perfume.png", alt: "Blossom natural perfume bottle with fruit peel ingredients", loading: "eager", fetchPriority: "high", className: "relative z-10 w-full h-full object-contain rounded-2xl border-0" }) }),
