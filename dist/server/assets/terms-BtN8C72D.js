...
import { B as BlurFade, A as Avatar, a as AvatarFallback, S as ScrollArea, C as Card, l as CardContent, m as Separator, n as CardHeader, o as CardTitle } from "./router-CtctPOdV.js";
...
function TermsPage() {
  return /* @__PURE__ */ jsxs("main", { className: "pt-24", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-16", children: /* @__PURE__ */ jsxs("div", { className: "max-w-3xl mx-auto px-4 sm:px-6 lg:px-8", children: [
      /* @__PURE__ */ jsx(ScrollArea, { className: "w-full mb-8", children: /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, children: sections.map((s) => /* @__PURE__ */ jsxs(AccordionItem, { value: s.id, children: [
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { className: "text-2xl font-heading font-bold", children: "10. Contact" }) }),
...
const SplitComponent = () => /* @__PURE__ */ jsx(TermsPage, {});
export {
