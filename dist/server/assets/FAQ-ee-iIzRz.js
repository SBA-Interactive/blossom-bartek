...
import { B as BlurFade, b as Badge, s as Tabs, t as TabsList, v as TabsTrigger, h as Button, G as TabsContent, C as Card, n as CardHeader, o as CardTitle, A as Avatar, a as AvatarFallback, p as CardDescription, l as CardContent } from "./router-CtctPOdV.js";
import { A as Accordion, a as AccordionItem, b as AccordionTrigger, c as AccordionContent } from "./accordion-6YEcb7e6.js";
import { Link } from "@tanstack/react-router";
import { HelpCircle, Leaf, Truck, RefreshCw, Package, ArrowRight } from "lucide-react";
...
function FAQ() {
  ...
  return /* @__PURE__ */ jsxs("main", { className: "pt-24", children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-12 sm:py-24", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, className: "max-w-3xl mx-auto", children: [
      /* @__PURE__ */ jsx("div", { className: "hidden md:block mb-8", children: /* @__PURE__ */ jsx(TabsList, { className: "grid grid-cols-4 h-auto bg-transparent p-0 gap-2 w-full", children: faqCategories.map((cat) => /* @__PURE__ */ jsxs(
        TabsTrigger,
        {
          value: cat.title,
      ...
      /* @__PURE__ */ jsx("div", { className: "md:hidden grid grid-cols-2 gap-3 mb-8", children: faqCategories.map((cat) => /* @__PURE__ */ jsxs(
        Button,
        {
          ...
          children: [
            /* @__PURE__ */ jsx(cat.icon, { className: "w-8 h-8" }),
            /* @__PURE__ */ jsx("span", { className: "text-sm font-bold", children: cat.title })
          ]
        },
        cat.title
      )) }),
      faqCategories.map((category) => /* @__PURE__ */ jsx(TabsContent, { value: category.title, children: /* @__PURE__ */ jsxs(Card, { children: [
        ...
        /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Accordion, { type: "single", collapsible: true, children: category.items.map((item, itemIndex) => /* @__PURE__ */ jsxs(AccordionItem, { value: `item-${itemIndex}`, children: [
    ...
    /* @__PURE__ */ jsx("section", { className: "py-24 bg-secondary/30", children: /* @__PURE__ */ jsx("div", { className: "container mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsx(BlurFade, { inView: true, children: /* @__PURE__ */ jsxs(Card, { className: "max-w-2xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxs(CardHeader, { children: [
      ...
      /* @__PURE__ */ jsx(CardContent, { children: /* @__PURE__ */ jsx(Button, { size: "lg", className: "group", asChild: true, children: /* @__PURE__ */ jsxs(Link, { to: "/contact", params: { id: "message-us" }, children: [
        "Contact Us",
