...
function WishlistItemCard(t0) {
  ...
  let t18;
  if ($[38] !== handleRemove) {
    t18 = /* @__PURE__ */ jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "ghost", size: "icon", onClick: handleRemove, children: t17 }) });
    $[38] = handleRemove;
    $[39] = t18;
  } else {
    t18 = $[39];
