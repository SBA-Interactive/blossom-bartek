...
const BentoCard = ({
  ...
  <div
    key={name}
    className={cn(
      "group relative flex flex-col justify-between overflow-hidden rounded-xl transform-gpu transition-all duration-300",
      "hover:scale-[1.01] hover:shadow-xl",
      // light styles
      "bg-background [box-shadow:0_6px_18px_rgba(16,24,40,0.06)]",
      // dark styles
      "dark:bg-background dark:[box-shadow:0_8px_28px_rgba(2,6,23,0.6)]",
      className,
    )}
    {...props}
  >
