...
import { ProductCardGrid, products as allProducts, type Product } from "@/components/ProductCardGrid";
import { categories, badges } from "@/constants/products";
            ...
            <div className="flex items-center gap-3 w-full md:w-auto">
              <Sheet open={filterOpen} onOpenChange={setFilterOpen}>
                ...
                <SheetContent side="left" className="w-full sm:w-80">
                  ...
                  <div className="py-4 ml-8 2xl:ml-2 overflow-y-auto max-h-[70vh]">
                    <FilterPanel
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <SectionWrapper loading={false} error={null} loadingType="grid" loadingCount={6}>
            <div className="mb-4 text-sm text-muted-foreground">
              Showing {filteredAndSortedProducts.length} of {allProducts.length} fragrances
            </div>
            ...
            {filteredAndSortedProducts.length === 0 ? (
              ...
              >
                {filteredAndSortedProducts.map((product) => (
                  <ProductCardGrid key={product.id} product={product} featured={isFeatured(product.id)} />
                ))}
              </ul>
            )}
          </SectionWrapper>
